...
<span class="paragraph-timestamp" data-ts="01:47">01:47</span> **Seungjoon Choi** I enjoyed it, and I think I got a lot of good stimulation from it.

<span class="paragraph-timestamp" data-ts="01:49">01:49</span> **Chester Roh** There were a lot of presentations, but with all the laughing and chatting and talking with people, I didn't get to see every presentation, but Heo Yechan, who made Oh-My-Claude-Code and Oh-My-Codex, Heo Yechan's presentation was really interesting.
...
<span class="paragraph-timestamp" data-ts="08:55">08:55</span> **Seungjoon Choi** But you watched GTC while you were sick too, didn't you?

<span class="paragraph-timestamp" data-ts="08:57">08:57</span> **Chester Roh** I had nothing to do, so I watched Jensen Huang talking blankly for two hours. Seungjoon, did you watch GTC too?

<span class="paragraph-timestamp" data-ts="09:06">09:06</span> **Seungjoon Choi** No. I just watched some clips and thought, oh, I see, but I didn't look into it in detail.
...
<span class="paragraph-timestamp" data-ts="26:49">26:49</span> **Seungjoon Choi** Another interesting thought came to me while listening to Heo Yechan's presentation. You talked about things like crayfish graves. Looking at crayfish stew, the `.md`s that failed to succeed I mean, whether that was a program `.md` or a `SOUL.md`, if they fail to pass the fitness function, they get derived into the next different generation. We've heard this somewhere a lot before. It's what we did with genetic algorithms.

<span class="paragraph-timestamp" data-ts="27:15">27:15</span> **Chester Roh** It's the algorithm of evolution. If it adapts, it survives; if not, it dies.

<span class="paragraph-timestamp" data-ts="27:20">27:20</span> **Seungjoon Choi** So the good ones crossover, and those older algorithms that sometimes create mutations seem like they could all be applied to this way of thinking now.
...
<span class="paragraph-timestamp" data-ts="28:57">28:57</span> **Seungjoon Choi** Of course, in practice there are all sorts of complexities. Because if you get the evaluation criteria wrong, it will exploit that and make attempts to pass in bizarre ways.

<span class="paragraph-timestamp" data-ts="29:08">29:08</span> **Chester Roh** Because the model itself can also end up reward hacking. But those kinds of parts are actually similar to a company. There is a lot of practical work, but that organization has a hierarchy. There's the CEO, the executives, and then the team leads, and the team members.
...
<span class="paragraph-timestamp" data-ts="32:08">32:08</span> **Seungjoon Choi** Around last year, quoting what Noam Brown was saying, we said that the harness would eventually be absorbed into the model, but then the harness comes out again adapted to that, so as you said, it seems to take the shape of an Ouroboros.

<span class="paragraph-timestamp" data-ts="32:22">32:22</span> **Chester Roh** It's continuously moving in a thesis-antithesis-synthesis pattern, and that speed, over and over, is something I look at with awe and with fear, so it's accelerating.

<span class="paragraph-timestamp" data-ts="32:34">32:34</span> **Seungjoon Choi** I still haven't fully organized my thoughts on this, but between something that exists in the form of a neural net and that neural net using externalized tools, just as humans, humanity, have done, I wonder if this is some pattern that just keeps going, and that thought comes to me as well.
...
<span class="paragraph-timestamp" data-ts="36:59">36:59</span> **Seungjoon Choi** Didn't Sam lose a bit of steam?
...
<span class="paragraph-timestamp" data-ts="1:00:51">1:00:51</span> **Seungjoon Choi** The feeling is that after going around and around, it's plain vanilla after all.

<span class="paragraph-timestamp" data-ts="1:00:55">1:00:55</span> **Chester Roh** Right. It's sad even saying this. All this enormous effort we put in during that time and all that time, all of it went around in a circle, and in the end, relying on the model's capability overhang turned out to be the answer. That's the conclusion.
...
<span class="paragraph-timestamp" data-ts="1:02:56">1:02:56</span> **Seungjoon Choi** Then what makes me curious is between the 1/10x efficiency you mentioned earlier and 10x new biz, is there a causal relationship? Is there a correlation? Are they orthogonal to each other? Are they independent?

<span class="paragraph-timestamp" data-ts="1:03:10">1:03:10</span> **Chester Roh** I think it can be summarized like this. In the end, the nature of the objective is different.
...
<span class="paragraph-timestamp" data-ts="1:06:10">1:06:10</span> **Seungjoon Choi** Chester hunted on your own.
...
<span class="paragraph-timestamp" data-ts="1:10:23">1:10:23</span> **Seungjoon Choi** This is already somewhat old news, but when Elon acquired Twitter and all that, Jack Dorsey was very opposed to laying people off, but then Jack Dorsey himself

<span class="paragraph-timestamp" data-ts="1:10:35">1:10:35</span> **Chester Roh** cut a huge number of people.

<span class="paragraph-timestamp" data-ts="1:10:37">1:10:37</span> **Seungjoon Choi** Right, recently.

<span class="paragraph-timestamp" data-ts="1:10:38">1:10:38</span> **Chester Roh** He let go of several thousand people.

<span class="paragraph-timestamp" data-ts="1:10:39">1:10:39</span> **Seungjoon Choi** Four thousand, I think, anyway, that seems like one aspect that reflects the times, and from that perspective, what Chester is saying, at the company level, reveals a certain viewpoint, and listening through all of this today, people in their twenties who are now rising are going to push forward anyway rather than staying under the umbrella, so since we need to have a good relationship with them, we need to respect them and guide them and have that kind of good relationship with each other, and as for improving efficiency within the company, how to achieve efficiency is, in a way, just a given now. It's something already happening, and if you don't do it, you'll actually fall behind.
...
<span class="paragraph-timestamp" data-ts="1:11:27">1:11:27</span> **Chester Roh** I think that's how it can be summarized. In any case, it's not that I like this kind of thing either, I like technical things and I like making things, but on the company management side, by constantly bringing in these dynamics and converting them into business, reality, and then the ideals we have to pursue in the short term, and the ideals we have to pursue in the long term, things like that seem to come into focus.

## Prompt injection and isolated operations    *1:11:51*

<span class="paragraph-timestamp" data-ts="1:11:51">1:11:51</span> **Seungjoon Choi** Right now, in the end, with agents, our being able to use agents well is because of prompts, but if agents come in after getting injected, then there is a risk they could break through things like 2FA too, right? Isn't that something that fundamentally can't really be solved?

<span class="paragraph-timestamp" data-ts="1:12:08">1:12:08</span> **Chester Roh** I think so. I think they might even be able to break through 2FA. Because if the agent can read email too.

<span class="paragraph-timestamp" data-ts="1:12:13">1:12:13</span> **Seungjoon Choi** So actually, this issue related to security gives me the sense that something huge is slowly creeping up.

<span class="paragraph-timestamp" data-ts="1:12:21">1:12:21</span> **Chester Roh** That's why I couldn't bring myself to install OpenClaw on my laptop. So with OpenClaw, I installed a VM, set up Linux fresh, and ran OpenClaw on top of that and tested all sorts of things, and once it worked and I thought, "Ah, this is pretty good at things," then outside, I got hold of a DGX box and now I've set up OpenClaw on there all the way through and I'm putting in the minimum data and things it needs to be shown.

<span class="paragraph-timestamp" data-ts="1:12:53">1:12:53</span> **Seungjoon Choi** But if I don't give it my credentials, doesn't it lose value as an assistant?

<span class="paragraph-timestamp" data-ts="1:12:59">1:12:59</span> **Chester Roh** Yes, so for things related to social accounts or things related to finance, I still can't give it those, and for unit tasks, even if this document somehow gets leaked in full, things that carry almost no risk for me are what I'm entrusting it with.
...
<span class="paragraph-timestamp" data-ts="1:13:43">1:13:43</span> **Seungjoon Choi** There's that too, but they can also come in already brainwashed. Agents get injections. Since that still can't be fundamentally solved, for now, that's a headache of a problem right now, so I think there could be a possibility of incidents and accidents.
...
<span class="paragraph-timestamp" data-ts="1:14:10">1:14:10</span> **Chester Roh** There's no way not to do it. That's why everyone's putting it out.
...
<span class="paragraph-timestamp" data-ts="1:14:31">1:14:31</span> **Chester Roh** Right, but this too is clearly a snapshot from March 2026, and my thoughts change 20 times a day too.

<span class="paragraph-timestamp" data-ts="1:14:40">1:14:40</span> **Seungjoon Choi** Around March or April of last year, that was when we were saying Chester and ADK are incredible.

<span class="paragraph-timestamp" data-ts="1:14:46">1:14:46</span> **Chester Roh** When Claude Code was just starting to come out. Pydantic was the most minimal and pretty solid. We were saying, let's use Pydantic, and that was March of last year.

<span class="paragraph-timestamp" data-ts="1:14:56">1:14:56</span> **Seungjoon Choi** And for me too, around April, was it the Chrome DevTools Protocol, I was using CDP to experiment with browser agents, but now, well, they've all just become things that work fine.

<span class="paragraph-timestamp" data-ts="1:15:06">1:15:06</span> **Chester Roh** Back then, I was still using GitHub Copilot for tab coding. I was still taking the lead on the main code myself and getting assistance, so moving to Claude Code felt a bit uncomfortable. Honestly, going all the way to full agent coding.

<span class="paragraph-timestamp" data-ts="1:15:22">1:15:22</span> **Seungjoon Choi** Even now, with moving toward OpenClaw, I actually still have a bit of resistance to it, so I don't make that shift all at once. But I think there are probably a lot of similar situations. Still, I do think it's something we have to move toward.

## Keeping pace like yacht racing    *1:15:33*

<span class="paragraph-timestamp" data-ts="1:15:33">1:15:33</span> **Chester Roh** So in my life too, I thought, ah, this is a yacht race, and if things change and that's what those younger people are doing, then I absolutely have to keep up with them too, and that's how I changed my mindset.
...
<span class="paragraph-timestamp" data-ts="1:15:54">1:15:54</span> **Seungjoon Choi** Gubong, Yeongyu, Yechan, and also Wonjoon, who appeared with us, are all continuously building those kinds of dynamic relationships and trying things out, in really interesting and multifaceted ways. Seeing people in their 20s and 30s being active like that is really jumping out at me now.

<span class="paragraph-timestamp" data-ts="1:16:14">1:16:14</span> **Chester Roh** Minseok too, CEO Minseok also started that up. In the end, the company seems to have taken a direction similar to OpenClaw, with this kind of assistant approach, so it might be good to invite Minseok on and talk about what kind of business thesis Minseok has as well.
...
<span class="paragraph-timestamp" data-ts="1:16:40">1:16:40</span> **Seungjoon Choi** and Jinhyung is there too, and Jinhyung and others seem to know all those people.

## Closing    *1:16:45*

<span class="paragraph-timestamp" data-ts="1:16:45">1:16:45</span> **Chester Roh** Then I think we'll stop around here for today, and take good care of your health. We're at the age where we really need to take care of our health. Then we'll wrap things up around here for today. Thank you.

<span class="paragraph-timestamp" data-ts="1:16:53">1:16:53</span> **Seungjoon Choi** It was fun. Thank you.
