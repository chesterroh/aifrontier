...
![OpenAI blog post 'Advancing science and mathematics with GPT-5.2' — published on December 11, 2025. Introductory text stating that GPT-5.2 delivers the strongest performance in mathematics and science.](/episodes/ep80/notion_04.png)
...
![OpenAI research page 'Evaluating AI's capacity for scientific research' — description stating that FrontierScience is a benchmark for evaluating expert-level scientific reasoning across physics, chemistry, and biology.](/episodes/ep80/notion_06.png)
...
![OpenAI blog post 'Evaluating AI's ability to accelerate biology research in laboratory settings' — published on December 16, 2025. Introduction stating that GPT-5 improved a novel laboratory protocol and increased the efficiency of a molecular cloning protocol by up to 79 times.](/episodes/ep80/notion_05.png)
...
![Card-style thumbnail 'The story of Erdős problem #1026 / The story of Erdős problem #1026' — illustration of directional arrows connecting piles of coins into a network graph with a tile pattern.](/episodes/ep80/notion_07.png)
...
![Card-style thumbnail 'The Present of Mathematical Proof Human×AI / The Present of Mathematical Proof Human×AI' — cursive signature image on a white background.](/episodes/ep80/notion_08.png)
...
![YouTube thumbnail — Google DeepMind The Podcast. Demis Hassabis and Hannah Fry sit across from each other at a podcast studio table in conversation. Title: 'The future of intelligence | Demis Hassabis (Co-founder and CEO of DeepMind)'.](/episodes/ep80/notion_01.png)
...
![Hand-drawn diagram — model development stages progressing from a young garlic sprout (Garlic model early checkpoint) → GPT-5.2 (current) → more training/more data/more tuning → fully grown garlic (Garlic model full-blown).](/episodes/ep80/notion_10.png)
...
![The text logo 'Xiaomi MiMo' in bold black lettering on a white background.](/episodes/ep80/notion_11.png)
