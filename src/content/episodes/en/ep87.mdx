...
![METR software task time-horizon graph (linear scale). Shows the time required to reach a 50% success rate by model release date, from GPT-2 to Claude Opus 4.6. Claude Opus 4.6 is positioned highest at about 14.5 hours.](/episodes/ep87/notion_02.png)
...
<ResourceLink url="https://x.com/metr_evals/status/2024923422867030027" title="METR: Claude Opus 4.6 Time Horizon" domain="x.com" />
...
![Google AI Studio screen. Next to a blue star icon, a status indicator shows 'Thinking' alongside the text 'Gemini 3.1 Pro Preview · Running for 30348s'.](/episodes/ep87/notion_03.png)
...
<ResourceLink url="https://x.com/JeffDean/status/2024525132266688757" title="Jeff Dean: Gemini 3.1 Pro announcement" domain="x.com" />
...
![Modular blog post cover image. Bold title 'The Claude C Compiler' with the subtitle 'What It Reveals About the Future of Software.' An abstract constructivist-style artwork with black lines, a red circle, and a blue triangle forms the background.](/episodes/ep87/notion_04.png)
...
<ResourceLink url="https://www.modular.com/blog/the-claude-c-compiler-what-it-reveals-about-the-future-of-software" title="The Claude C Compiler: What It Reveals About the Future of Software" domain="modular.com" />
...
<ResourceLink url="https://deepmind.google/blog/accelerating-mathematical-and-scientific-discovery-with-gemini-deep-think/" title="Gemini Deep Think: Redefining Scientific Research" domain="deepmind.google" />
...
<ResourceLink url="https://www.isomorphiclabs.com/articles/the-isomorphic-labs-drug-design-engine-unlocks-a-new-frontier" title="Isomorphic Labs Drug Design Engine" domain="isomorphiclabs.com" />
...
![OpenAI blog header. Large title 'GPT-5.2 derives a new result in theoretical physics' with the description 'In a new preprint, GPT-5.2 proposed a formula for a gluon amplitude later proved by an internal OpenAI model and verified by the authors.' Dated February 13, 2026.](/episodes/ep87/notion_05.png)
...
![Abstract geometric art cover image. White serif text reading 'Harness Engineering' over a Mondrian-style grid pattern in red, blue, yellow, and black.](/episodes/ep87/notion_06.png)
...
<ResourceLink url="https://martinfowler.com/articles/exploring-gen-ai/harness-engineering.html" title="Harness Engineering — Martin Fowler" domain="martinfowler.com" />
...
![shumer.dev blog post cover. In bold golden text, 'Something Big Is Happening,' with 'Matt Shumer' below and the subtitle 'Insights on building AI products, models, and demos.'](/episodes/ep87/notion_10.png)
...
![Dark-themed code editor screen. Python code is shown in three columns under the title 'microgpt.' A full implementation of Value class-based automatic differentiation and a transformer fits on a single screen.](/episodes/ep87/notion_11.png)
