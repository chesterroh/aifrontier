...
![A line graph or scatter plot screen comparing the task execution time horizons of multiple AI models](/episodes/ep87/ep87_0230_metr_time_horizon_graph.jpg)
*📷 A line graph or scatter plot screen comparing the task execution time horizons of multiple AI models*
...
![A Gemini 3.1 Pro announcement page or a product introduction screen with performance comparisons](/episodes/ep87/ep87_0346_gemini_31_pro_release.jpg)
*📷 A Gemini 3.1 Pro announcement page or a product introduction screen with performance comparisons*
...
![A blog page showing the title and featured image of a Claude C compiler review article](/episodes/ep87/ep87_0511_claude_c_compiler_review.jpg)
*📷 A blog page showing the title and featured image of a Claude C compiler review article*
...
![A page showing the title or featured thumbnail of an article about GPT-5.2 and theoretical physics](/episodes/ep87/ep87_1111_gpt52_theoretical_physics.jpg)
*📷 A page showing the title or featured thumbnail of an article about GPT-5.2 and theoretical physics*
...
![A webpage showing the title and featured graphic or interface of an article about harness engineering](/episodes/ep87/ep87_2141_harness_engineering.jpg)
*📷 A webpage showing the title and featured graphic or interface of an article about harness engineering*
...
![A microgpt example page or a screen showing a simple GPT code example](/episodes/ep87/ep87_2953_microgpt_example.jpg)
*📷 A microgpt example page or a screen showing a simple GPT code example*
