...
<span class="paragraph-timestamp" data-ts="6:57">6:57</span> But the people arguing the opposite side say, “No. Even if this gets built anyway, only the tens of thousands of people at the top and a few companies engaged in knowledge work will be able to use it effectively, and people’s lives won’t change all that much. And as models become more efficient and edge computing also becomes more efficient, with each model able to handle more work, demand for computation won’t increase that much. So that’s a bubble.” These two perspectives are still fiercely competing, and I don’t think the market has decided yet which direction things will take.
...
<span class="paragraph-timestamp" data-ts="22:04">22:04</span> With benchmarks, the first page always has summaries and something showing that our benchmark performance has improved by this much. This Kimi K3 did a lot of truly unusual things. Here are the points they publicly emphasized. They scaled their model to around 2.8T parameters. Then it has 104B activated parameter, and they say the context window is 1M token, followed by KDA, then Attention Residual and Stable Latent MoE.


## 2.8T parameters and 1M context: Kimi K3’s key specifications    *22:13*

<span class="paragraph-timestamp" data-ts="22:36">22:36</span> **Chester Roh** Broadly speaking, these cover what innovation KDA introduced in attention, then what changes Attention Residual made between transformer block,

<span class="paragraph-timestamp" data-ts="22:46">22:46</span> **Seungjoon Choi** Early on, this year—

<span class="paragraph-timestamp" data-ts="22:47">22:47</span> **Chester Roh** and what changes were made to MoE.

<span class="paragraph-timestamp" data-ts="22:47">22:47</span> **Seungjoon Choi** A few in the first half, some kind of…
...
<span class="paragraph-timestamp" data-ts="27:01">27:01</span> **Seungjoon Choi** from the days of RNNs.

<span class="paragraph-timestamp" data-ts="27:06">27:06</span> **Chester Roh** That's it. Yes, exactly. LSTM was a recurrent model that ran continuously with gates determining what to remember and what to forget. I became deeply interested in this for a while, and the intuition behind SSMs, State Space

<span class="paragraph-timestamp" data-ts="27:20">27:20</span> **Jonghyun Park** Models, commonly known through

<span class="paragraph-timestamp" data-ts="27:27">27:27</span> **Chester Roh** Mamba, was this: during training, like a transformer, you can feed in the entire sequence at once in parallel and train it, while during inference, like a typical recurrent model, a single model can continuously output words. What if we made a model like that? That would eliminate much of the transformer's inefficiency. That was the intuition behind Mamba, and this combines transformers, Mamba, and LSTM.
...
<span class="paragraph-timestamp" data-ts="29:42">29:42</span> **Seungjoon Choi** It changes little by little, little by little, little by little, little by little—

<span class="paragraph-timestamp" data-ts="29:45">29:45</span> **Chester Roh** that's the delta. They simply parameterize that and train it. Please don't ask me why that works. They must have done it because it works.
...
<span class="paragraph-timestamp" data-ts="93:24">93:24</span> **Seungjoon Choi** Then the answer is semi-automation. The answer isn't to pursue automation, but semi-automation.
