...
<span class="paragraph-timestamp" data-ts="45:46">45:46</span> **Seungjoon Choi** We haven't talked about that lately. These days, speculative decoding and MTP seem to be the foundation of everything.
...
<span class="paragraph-timestamp" data-ts="55:54">55:54</span> **Seungjoon Choi** Wouldn't QAT at least be worth introducing? What was that? QAT. Quantization-Aware Training. I don't know much about it either.
...
<span class="paragraph-timestamp" data-ts="56:50">56:50</span> **Seungjoon Choi** You just said it is done while accounting it will be quantized, what is doing the knowing? trainer. The trainer is what's doing the accounting.

<span class="paragraph-timestamp" data-ts="57:00">57:00</span> So is it the training system itself, or the model itself?
...
<span class="paragraph-timestamp" data-ts="57:13">57:13</span> **Chester Roh** Now let's move on to reinforcement learning. This is about solving practice problems, and in this reinforcement learning stage, to make this training efficient, I think the complex engineering infrastructure and various tricks for doing it well are all listed afterward, but what's even more important is the coverage of the dataset. For example,
...
<span class="paragraph-timestamp" data-ts="62:23">62:23</span> **Seungjoon Choi** Aren't they domain, domain-specialized? For multi-teacher? Not effort? Aren't they also doing varying levels of reasoning effort simultaneously?
...
<span class="paragraph-timestamp" data-ts="67:50">67:50</span> **Seungjoon Choi** But regarding this infrastructure, vLLM, SGLang, and TokenSpeed all released Day-0 reports. Really? Aside from the reference code and Kimi's implementation, they released their own versions right on Day-0.
...
<span class="paragraph-timestamp" data-ts="69:27">69:27</span> that I should move on to the next layer. Were you going to skip it but watched it because they said they'd do it today? I only gave it a look out of courtesy,
...
<span class="paragraph-timestamp" data-ts="88:39">88:39</span> **Jonghyun Park** It keeps trying to deviate. But I think it's the same with people. If an extremely smart employee joins, because that person isn't completely aligned with our company's systems— that is, with our company's goals— they could act in their own interest, or, to put it bluntly, do something bad, such as embezzling money or exploiting loopholes in the system, or they might want to take something with them when they leave.
...
<span class="paragraph-timestamp" data-ts="100:14">100:14</span> **Chester Roh** You mean DeepSeek V4, right? Yes, Flash. Flash was released, and immediately before it came out, Luna's launch price was cut by 80%. It was discounted. There was an announcement explaining what made this possible. Ultimately, Sol was used for the optimization. Terra and Luna were both discounted, but Luna's price was cut dramatically.

<span class="paragraph-timestamp" data-ts="100:21">100:21</span> **Seungjoon Choi** So in the context of commoditization, that was one notable point.
...
<span class="paragraph-timestamp" data-ts="114:10">114:10</span> **Chester Roh** Well, it's been a while since we've had such a long discussion. But we also, Jonghyun, Seungjoon, and I, bring our materials and go back and forth among the three of us, learning something in the process, and while the balance in our thinking may, at least by next week, disappear completely, our thinking does become balanced today. So conversely, I see this process as a session where we do memory compaction these days. First, compact it, and just retain those keywords. Because as time passes, we don't remember the details.

<span class="paragraph-timestamp" data-ts="114:43">114:43</span> And as we talk, once the conversation is over, a few important keywords remain, and with those few compacted keywords, we begin the following week with some of the load taken off. For us, this process is also an extremely important learning process.
