...
![Example of GPT-5.4 Thinking presenting a plan and adding detail](/episodes/ep89/ep89_0210_gpt54_thinking_plan.jpg)
*📷 Example of GPT-5.4 Thinking presenting a plan and adding detail*
...
![Example of Mr.doob's Three.js-based Quake port](/episodes/ep89/ep89_0514_threejs_quake_port.jpg)
*📷 Example of Mr.doob's Three.js-based Quake port*
...
![Example of an executable specification built with Alloy](/episodes/ep89/ep89_0943_alloy_executable_spec.jpg)
*📷 Example of an executable specification built with Alloy*
...
![Experiment log with dozens of conversations and a large amount of accumulated code](/episodes/ep89/ep89_3038_chat_volume_experiment.jpg)
*📷 Experiment log with dozens of conversations and a large amount of accumulated code*
...
![Screen from a paper-to-one-click experiment conducted with GPT-5.4](/episodes/ep89/ep89_3305_paper_to_click.jpg)
*📷 Screen from a paper-to-one-click experiment conducted with GPT-5.4*
...
![Screen from a source-to-one-click experiment conducted with GPT-5.4](/episodes/ep89/ep89_3315_source_to_click.jpg)
*📷 Screen from a source-to-one-click experiment conducted with GPT-5.4*
...
![The process of narrowing down the problem by repeating hypotheses and experiments](/episodes/ep89/ep89_3836_hypothesis_experiment_loop.jpg)
*📷 The process of narrowing down the problem by repeating hypotheses and experiments*
