...
<span class="paragraph-timestamp" data-ts="14:16">14:16</span> **Seungjoon Choi** But if you calculate the publicity benefits they would enjoy if they solved it, that's cheap. Right. But they did spend far more than the Millennium Prize money. The Millennium Prize is one million dollars. But operating 10,000 agents simultaneously— of course, based on the hypotheses I discussed with the model earlier, they don't all communicate at once, but even if they communicate in groups, it means we're now at a point where this can be orchestrated. It does seem frightening. If a problem looks solvable, they're willing to spend this kind of money on it.
...
<span class="paragraph-timestamp" data-ts="33:29">33:29</span> **Seungjoon Choi** There's also a new GPT image model. That was worth checking out too. What's fascinating is that there were rumors about all of this. Rumors that it was coming. And every one of those rumors is turning out to be true.
...
<span class="paragraph-timestamp" data-ts="35:13">35:13</span> The images also became increasingly grainy. Around GPT Image 2. Yes, here, you keep this one image open and control it continuously. These are the previous version and the new version, and when you change the clothes, the consistency gradually breaks down. It still looks similar, though. But this one definitely maintains consistency much better. So it works well for editing. I think that's what they wanted to highlight.
...
<span class="paragraph-timestamp" data-ts="38:22">38:22</span> **Jonghyun Park** Right. It feels like I've been using Astra for ages, but it turns out I've only used it for two days. You're right. I used mine all up too, so was that one reset, or two? I think I used two.

<span class="paragraph-timestamp" data-ts="38:36">38:36</span> **Chester Roh** The task I started last night and left running while I slept was solved. Congratulations. This is work that we're doing, but we talked about this in the previous episode: while it is the model doing the work, ultimately, we still reap the rewards of the results, so we shouldn't be too sad about it.
...
<span class="paragraph-timestamp" data-ts="51:55">51:55</span> Right. You can install Blender too. So I've tried running Blender as well. But when you run something like Blender, it actually uses quite a lot of compute.
...
<span class="paragraph-timestamp" data-ts="52:47">52:47</span> All right. But there's something else too. There's one more thing, right?
...
<span class="paragraph-timestamp" data-ts="1:22:43">1:22:43</span> **Jonghyun Park** Both general-purpose and personalized drug development. Right. Ultimately, AlphaGenome has been released, and I'm curious about what kind of social impact it will have. It will probably play a role in every path toward extending human lifespan, but I can't immediately get a sense of just how much it has accelerated that progress, so I'm curious about those things.
...
<span class="paragraph-timestamp" data-ts="1:31:04">1:31:04</span> **Seungjoon Choi** It's so fascinating that lately, I live each day for the pleasure of reading about this field. But if you look at the reports coming out these days, they always include cybersecurity and biosecurity. Whenever a large model is released. Of course, there are positive applications, but there will probably be frightening ones too.
...
<span class="paragraph-timestamp" data-ts="1:32:39">1:32:39</span> **Chester Roh** We talked about the Millennium Problems today, and o1 came out in September 2024. So it's been exactly two years. It's been two years, and even the things we're talking about are quite incredible. In just two years, we're now
...
<span class="paragraph-timestamp" data-ts="1:34:10">1:34:10</span> **Chester Roh** Anyway, since our last recording, only three days have passed. There was a lot to talk about. So this ended up being a brief recap of the past three days. Indeed. We've been talking for almost two hours.

<span class="paragraph-timestamp" data-ts="1:34:26">1:34:26</span> Well then, have a good business trip. We'll wrap things up here for today. Thank you.

<span class="paragraph-timestamp" data-ts="1:34:31">1:34:31</span> **Jonghyun Park** Great work, everyone. Take care.