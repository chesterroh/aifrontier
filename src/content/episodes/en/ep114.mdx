...
<span class="paragraph-timestamp" data-ts="01:39">01:39</span> **Seungjoon Choi** That's why the claim that a Millennium Prize Problem has now been solved is attracting so much public attention. If you look at the material, it also covers simulations that run continuously.
...
<span class="paragraph-timestamp" data-ts="02:31">02:31</span> **Seungjoon Choi** But an interesting point made in this article is that their announcement in 2000 was extremely significant, and over the roughly 26 years since then, numerous attempts have produced valuable byproducts. As a result,
...
<span class="paragraph-timestamp" data-ts="18:01">18:01</span> **Seungjoon Choi** The people shown here are mathematicians whose prior research gave Levent Alpöge and Buckmaster their ideas. And this part involves a completely separate group, people who approached the problem in a different way around the same time.
...
<span class="paragraph-timestamp" data-ts="32:26">32:26</span> **Seungjoon Choi** Yes, exactly. So this story has only just broken, so I think we'll have to see how it develops, but it's both fascinating and unsettling.
...
<span class="paragraph-timestamp" data-ts="34:43">34:43</span> **Jonghyun Park** Seeing things like that made me realize that its ability to see has definitely improved a lot.
...
<span class="paragraph-timestamp" data-ts="36:23">36:23</span> **Jonghyun Park** There is quite a bit of related research. So researchers have been exploring how this could be used,
...
<span class="paragraph-timestamp" data-ts="38:36">38:36</span> **Seungjoon Choi** The task I started last night and left running while I slept was solved.
...
<span class="paragraph-timestamp" data-ts="43:27">43:27</span> **Chester Roh** Eight hours? I didn't just leave it alone for eight hours, because while I was working, there were things that required my decisions and were put on hold, so I kept it beside me and let it run in the background all day, and whenever it asked me something, I said, “I don't know. Just look at the map, plan the route yourself, and choose whatever seems good.” And it just kept going.
...
<span class="paragraph-timestamp" data-ts="44:41">44:41</span> **Chester Roh** I remembered how Greg Brockman recently came on and said, “Codex is a super app.” I hadn't visited a single website myself the entire time. It even went to MyRealTrip and contacted guides, just in case, since it was also my first time visiting the area. When I told it to contact them, it sent all the messages too. And it even finished communicating with them.
...
<span class="paragraph-timestamp" data-ts="46:34">46:34</span> **Chester Roh** But apparently, that happens quite often in Europe. Seeing Korean payment gateway providers impose those measures so strictly does make me think I'm going to a dangerous country. I never had to do this when going to the US.
...
<span class="paragraph-timestamp" data-ts="47:57">47:57</span> **Jonghyun Park** Which one do you like best?
...
<span class="paragraph-timestamp" data-ts="59:12">59:12</span> **Chester Roh** So how are they made different?
...
<span class="paragraph-timestamp" data-ts="1:05:12">1:05:12</span> **Chester Roh** No, that's not it. There's simply a sequence of three billion A, G, T, C letters, right? So if there's one of A, G, T, C, another base pairs with it, such as adenine or guanine—
...
<span class="paragraph-timestamp" data-ts="1:08:27">1:08:27</span> **Chester Roh** When we have our genomes analyzed, we can learn everything from the genomic data. The way it works is,
...
<span class="paragraph-timestamp" data-ts="1:11:55">1:11:55</span> **Chester Roh** But I mentioned SNPs, and as you move along, if only one letter differs, then naturally, the question of exactly what problem that single-letter difference causes becomes important. Right. Some variants are deleterious and harmful, while other variants cause no major harm even if they differ. But differences of just one or two letters can change people’s lives. Genetic diseases—statistically speaking, that’s right. Genetic diseases are examples of that.
...
<span class="paragraph-timestamp" data-ts="1:20:23">1:20:23</span> **Chester Roh** The same goes for AlphaGenome. AlphaFold also used the 200,000 already known structures in PDB, which were the results of human experiments, to predict the remaining 200 million. And those predictions turned out to be highly accurate. Likewise, for the past 20 years, AlphaGenome has had all the experimental results showing what changes occur in exons or regulatory regions when genetic variants arise. All of those experimental results are available. It's a much smaller dataset than an LLM's. How many experiments could humans possibly have conducted?
