...
<span class="paragraph-timestamp" data-ts="14:05">14:05</span> So that's about $7.1 million. Right. So we can estimate that they spent more than $7.1 million. On this one thing alone.

<span class="paragraph-timestamp" data-ts="14:11">14:11</span> **Jonghyun Park** You calculated that on the assumption that all those tokens were output tokens, right? Right. It's a simple calculation.
...
<span class="paragraph-timestamp" data-ts="33:22">33:22</span> **Chester Roh** We recorded on Sunday, and it's Wednesday, so it's only been about three days. There's more, isn't there?

<span class="paragraph-timestamp" data-ts="33:27">33:27</span> Yes, shall we move on to the next one?


## The launch of GPT Image 2.5 and Astra’s vision capabilities    *33:29*

<span class="paragraph-timestamp" data-ts="33:29">33:29</span> **Chester Roh** There's also a new GPT image model. That was worth checking out too. What's fascinating is that there were rumors about all of this. Rumors that it was coming. And every one of those rumors is turning out to be true.
...
<span class="paragraph-timestamp" data-ts="37:29">37:29</span> It was a year ago. Looking at it that way, it strikes me once again just how quickly things have changed.
...
<span class="paragraph-timestamp" data-ts="38:22">38:22</span> **Chester Roh** Right. It feels like I've been using Astra for ages, but it turns out I've only used it for two days. You're right. I used mine all up too, so was that one reset, or two? I think I used two.

<span class="paragraph-timestamp" data-ts="38:36">38:36</span> **Seungjoon Choi** The task I started last night and left running while I slept was solved. Congratulations.
...
<span class="paragraph-timestamp" data-ts="40:16">40:16</span> **Seungjoon Choi** That's when using the API, right? Yes, when using the API. You must be able to generate quite a lot with the subscription too.
...
<span class="paragraph-timestamp" data-ts="41:34">41:34</span> **Chester Roh** So they're going with space-themed names for everything. Astra, Sol. Right. It seems like they're continuing to push that kind of naming scheme.

<span class="paragraph-timestamp" data-ts="41:42">41:42</span> Names like that should really be used by SpaceX and xAI, but OpenAI is taking all those terms and So they're exhausting the supply. Lately, I've been hearing recommendations from all over to try Grokbot. That's right. I've been getting a lot of recommendations to try Grok's latest model and things like that.
...
<span class="paragraph-timestamp" data-ts="43:24">43:24</span> With computer use? Eight hours? I didn't just leave it alone for eight hours, because while I was working, there were things that required my decisions and were put on hold, so I kept it beside me and let it run in the background all day, and whenever it asked me something, I said, “I don't know. Just look at the map, plan the route yourself, and choose whatever seems good.” And it just kept going.

<span class="paragraph-timestamp" data-ts="43:49">43:49</span> Things like booking train tickets? It does everything. I was glancing over at it while it worked, and it was reading a page in Italian, clicking this and that, and saying, “This is expensive, but using this fare seems like it would be much better, so I'll choose this one.” It also booked all the restaurants, and what else did it do?

<span class="paragraph-timestamp" data-ts="44:08">44:08</span> Accommodations. Hotel reservations were a given. It visited several hotel sites and compared prices, then said it seemed cheapest to book directly, “So I'll book it here.” That's how it handled it.

<span class="paragraph-timestamp" data-ts="44:20">44:20</span> You didn't check how many tokens it used, did you? No. I had it set to Fast mode, and since these aren't sites with multimodal APIs, it simply opens the browser and uses computer use for everything. The tokens drain rapidly. You can practically see them draining away, and as I sat there watching that,
...
<span class="paragraph-timestamp" data-ts="45:05">45:05</span> **Jonghyun Park** So were you happy with the accommodations and transportation Astra chose? I'll go there and find out for myself. I don't know yet.

<span class="paragraph-timestamp" data-ts="45:16">45:16</span> **Chester Roh** Then did you let it handle the payments too? I entered the payment information, and I handled only a few steps in the process, but when I tried simply letting it do some of them, there were things it refused to do. It said it couldn't do those itself. I like Astra so much that I've started giving it access to everything on my computer. I'm on the verge of giving it my credit card number too.

<span class="paragraph-timestamp" data-ts="45:39">45:39</span> You shouldn't do that. Exactly. I'm on the verge of entrusting everything to the agent. My personal information and all that have already been leaked to Chinese hackers anyway, so what difference does it make if OpenAI has another copy? It's that quintessentially Korean mindset.
...
<span class="paragraph-timestamp" data-ts="51:00">51:00</span> **Jonghyun Park** By whom? Astra. Did Astra do it using something like Blender?
...
<span class="paragraph-timestamp" data-ts="51:55">51:55</span> **Seungjoon Choi** Right. You can install Blender too. So I've tried running Blender as well. But when you run something like Blender, it actually uses quite a lot of compute.

<span class="paragraph-timestamp" data-ts="52:03">52:03</span> **Seungjoon Choi** Right. How are you charged for things like that? There's no separate charge, and they give you 100GB of storage. So the binaries there aren't retained for very long, but files you move into storage are retained. As I've kept using it, I found that I was already using about 2GB out of the 100GB. But in Chat mode, they give you four virtual CPUs, and in Work mode, they give you eight, but no GPU. Neither mode does.
...
<span class="paragraph-timestamp" data-ts="52:47">52:47</span> **Chester Roh** All right. But there's something else too. There's one more thing, right?
...
<span class="paragraph-timestamp" data-ts="1:31:21">1:31:21</span> **Jonghyun Park** How these things might be used. Right. Chemistry and biology are frightening in their own ways, too.
...
<span class="paragraph-timestamp" data-ts="1:32:54">1:32:54</span> **Seungjoon Choi** talking about things from science fiction. In 2026. It's killing me trying to keep up. Seriously.

<span class="paragraph-timestamp" data-ts="1:33:00">1:33:00</span> Biology isn't there yet either. If mathematicians have started experiencing their AlphaGo moment this year, biology isn't there yet and may simply be excited about having gained a new tool, but who knows?
...
<span class="paragraph-timestamp" data-ts="1:34:26">1:34:26</span> **Seungjoon Choi** Well then, have a good business trip. We'll wrap things up here for today. Thank you.

<span class="paragraph-timestamp" data-ts="1:34:31">1:34:31</span> **Seungjoon Choi** Great work, everyone. Take care.