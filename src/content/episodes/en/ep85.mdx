...
![Two-panel image depicting Ralph Wiggum from The Simpsons as a software engineer. The left panel reads "Software Engineer, Everything Is a Ralph Loop" and "Ralph Wiggum as a software engineer," and the right panel reads "everything is a ralph loop."](/episodes/ep85/notion_01.png)
...
![YouTube thumbnail showing Peter Steinberger seated in front of a camera. The title displayed is "How OpenClaw's Creator Uses AI to Run His Life in 40 Minutes | Peter Steinberger," and it is a video from the Peter Yang channel with 55.9K subscribers.](/episodes/ep85/notion_02.png)
...
![TBPN broadcast screen. Founder Matt Schlicht (@mattprd) appears remotely with the caption "MOLTBOOK CREATOR LIVE ON TBPN," while hosts Jordi Hays and John Coogan are together in the studio. The subtitle reads "Full Interview: Moltbook Creator's First Appearance Since Launch."](/episodes/ep85/notion_03.png)
...
![YouTube thumbnail showing a man with glasses seated at a microphone in a room with guitars hanging on the wall. At the bottom is the title from the Fraunhofer IEM channel: "Built your own AI coding agent: How Pi works – Inside AI #29."](/episodes/ep85/notion_05.png)
...
![Slide with the large heading "Opus 4.6 & GPT 5.3 Codex" and three link cards below it. From left to right are the Claude Opus 4.6 announcement page, the blog post "Advancing finance with Claude Opus 4.6," and the "Introducing GPT-5.3-Codex" page.](/episodes/ep85/notion_07.png)
...
![Diagram comparing the "Subagents" structure on the left with the "Agent Team" structure on the right. In Subagents, a Main Agent creates multiple Subagents that each produce a Result and Report back. In Agent Team, the Main Agent (Team Lead) works through a Shared Task List while teammates communicate with one another and collaborate on tasks.](/episodes/ep85/notion_09.png)
