...
![Graph screen comparing changes in the 50%-time horizon of multiple AI models with dots and lines](/episodes/ep82/ep82_0134_metr_time_horizon_graph.jpg)
*📷 Graph screen comparing changes in the 50%-time horizon of multiple AI models with dots and lines*
...
![Screenshot of a social media post showing the code-simplifier agent announcement and installation instructions](/episodes/ep82/ep82_1625_code_simplifier_agent.jpg)
*📷 Screenshot of a social media post showing the code-simplifier agent announcement and installation instructions*
...
![Metaphorical image where only some areas are revealed on a game screen or map while the surroundings remain dark](/episodes/ep82/ep82_1840_game_map_analogy.jpg)
*📷 Metaphorical image where only some areas are revealed on a game screen or map while the surroundings remain dark*
...
![Concept diagram showing with arrows how a conditional path is activated in an expression and leads to the next expression](/episodes/ep82/ep82_3214_hidden_state_path_circuit.jpg)
*📷 Concept diagram showing with arrows how a conditional path is activated in an expression and leads to the next expression*
