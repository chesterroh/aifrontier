...
![최근 AI·과학 관련 기사와 링크를 모아 놓은 정리 화면](/episodes/ep80/ep80_0049_recent_ai_science_signals.jpg)
*📷 최근 AI·과학 관련 기사와 링크를 모아 놓은 정리 화면*
...
![수식과 설명 문단, 성능 향상 내용을 함께 보여주는 논문 또는 블로그 화면](/episodes/ep80/ep80_0149_gpt52_math_scaling.jpg)
*📷 수식과 설명 문단, 성능 향상 내용을 함께 보여주는 논문 또는 블로그 화면*
...
![실험실 자동화 관련 도식이나 비교 차트가 포함된 연구 소개 화면](/episodes/ep80/ep80_0349_ai_wetlab_biology.jpg)
*📷 실험실 자동화 관련 도식이나 비교 차트가 포함된 연구 소개 화면*
...
![테렌스 타오의 에르되시 문제 글 제목과 본문 일부가 보이는 문서 화면](/episodes/ep80/ep80_0817_terence_tao_erdos.jpg)
*📷 테렌스 타오의 에르되시 문제 글 제목과 본문 일부가 보이는 문서 화면*
...
![수학 증명 사례를 항목별로 정리한 문서 또는 글 화면](/episodes/ep80/ep80_1130_state_of_math_proofs.jpg)
*📷 수학 증명 사례를 항목별로 정리한 문서 또는 글 화면*
...
![데미스 허사비스 인터뷰를 소개하는 제목 카드 또는 썸네일 화면](/episodes/ep80/ep80_1714_demis_hassabis_future.jpg)
*📷 데미스 허사비스 인터뷰를 소개하는 제목 카드 또는 썸네일 화면*
...
![NVIDIA Nemotron 모델 이름과 소개 문구가 보이는 제품 페이지 화면](/episodes/ep80/ep80_4558_nvidia_nemotron.jpg)
*📷 NVIDIA Nemotron 모델 이름과 소개 문구가 보이는 제품 페이지 화면*
...
![이미지 생성 결과를 여러 레이어로 나누어 보여주는 모델 페이지 화면](/episodes/ep80/ep80_5512_qwen_image_layered.jpg)
*📷 이미지 생성 결과를 여러 레이어로 나누어 보여주는 모델 페이지 화면*
